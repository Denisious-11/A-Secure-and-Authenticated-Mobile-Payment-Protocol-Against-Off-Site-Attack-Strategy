...
public class Merchant_request_recy extends RecyclerView.Adapter<Merchant_request_recy.MyViewHolder>
{
    ...
    public Merchant_request_recy(Context applicationContext, JSONArray jsonArray, Activity a) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.my_request_list, null);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(@NonNull View itemView)
        {
            ...
            b1 =(Button)itemView.findViewById(R.id.approve);
            b1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    StringRequest requ=new StringRequest(Request.Method.POST, "http://192.168.21.253:8000/approve/", new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response)
                        {
                            ...
                            try {
                                ...
                                if(dat.equals("yes"))
                                {
                                    Toast.makeText(context,"Purchase Approved Successfully",Toast.LENGTH_SHORT).show();
//                                    Toast.makeText(context,"Purchase Approved Successfully",Toast.LENGTH_SHORT).show();

                                    Intent i1= new Intent(context, Merchant_home.class);
