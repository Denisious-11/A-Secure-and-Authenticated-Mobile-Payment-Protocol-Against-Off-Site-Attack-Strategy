        ...
        b1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                else
                {
                    ...
                    StringRequest requ=new StringRequest(Request.Method.POST, "http://192.168.21.253:8000/find_login/", new Response.Listener<String>()
                    {
                        @Override
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                else if(dat.equals("Merchant"))
                                {
                                    ...
                                    Toast.makeText(LoginPage.this, "Merchant Login Successful!", Toast.LENGTH_SHORT).show();
                                    Intent i1=new Intent(LoginPage.this,Merchant_home.class);
                                    startActivity(i1);
                                }
